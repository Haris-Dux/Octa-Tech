...
const ServiceDetails = () => {
    ...
    return (
        <>
            ...
            <section className="max-w-4xl mx-auto px-5 mt-16 mb-16">

                <div className="text-center">
                    <h2 className="font-semibold text-3xl">Features you'll love</h2>
                    <p className="max-w-md mx-auto mt-2 text-gray-500">Lorem ipsum dolor sabore rerum impedit aperiam omnis modi eum deserunt magni?.</p>
                </div>
